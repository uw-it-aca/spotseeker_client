...
class SpotseekerTest(TestCase):
    ...
    def test_get_spot(self):
        with self.settings(
            RESTCLIENT_SPOTSEEKER_DAO_CLASS =
            ...
            self.assertEqual(spot_data.building_description, "This is a building")
            ...
            self.assertEqual(spot_data.last_modified, parse_datetime("2012-07-13T05:00:00+00:00"))
            ...
            self.assertEqual(spot_data.images[0].creation_date, parse_datetime("Sun, 06 Nov 1994 08:49:37 GMT"))
            self.assertEqual(spot_data.images[0].modification_date, parse_datetime("Mon, 07 Nov 1994 01:49:37 GMT"))
            ...
            self.assertEqual(spot_data.images[0].thumbnail_root, "/api/v1/spot/123/image/1/thumb")
